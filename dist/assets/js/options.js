...
eval("var saveButton = document.querySelector('#save-button');\nsaveButton.addEventListener('click', function () {\n  var checkbox = document.querySelector('#auto-trim');\n  browser.storage.local.set({\n    trimOnFocustLost: checkbox.checked\n  });\n});\nbrowser.storage.local.get().then(function (userSettings) {\n  var checkbox = document.querySelector('#auto-trim');\n  checkbox.checked = userSettings.trimOnFocustLost;\n});\n\n//# sourceURL=webpack:///./src/options.js?");
